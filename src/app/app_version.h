...
const char IDE_DISPLAY_NAME[] = "Qt Canpool";
const char IDE_ID[] = "qtcanpool";
const char IDE_CASED_ID[] = "QtCanpool";

#define IDE_VERSION 1.0.1
#define IDE_VERSION_STR STRINGIFY(IDE_VERSION)
#define IDE_VERSION_DISPLAY_DEF 1.1.0-rc1
