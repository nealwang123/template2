...
void QUIMessageBox::initControl()
{
    ...
    btnOk->setIcon(QIcon(":/imageTest/btn_ok.png"));
    ...
    btnCancel->setIcon(QIcon(":/imageTest/btn_close.png"));
...
void QUIDateSelect::initControl()
{
    ...
    btnClose->setIcon(QIcon(":/imageTest/btn_close.png"));
...
{
    int fontId = QFontDatabase::addApplicationFont(":/imageTest/fontawesome-webfont.ttf");
