...
void SocketFormMain::initForm(){
    frm1=new frmTcpClient();
    QVBoxLayout *hlayout1 = new QVBoxLayout;
    frm2=new MyPainterWidget();

    hlayout1->addWidget(ui->pushButton_Config);
    ...
    ui->tabWidget->addTab(mywidget, QIcon(QPixmap("Resources\\a11.png").scaled(150, 120)), "显示");//添加选项卡
...
void SocketFormMain::on_pushButton_Config_released()
{
    //绘图轨迹清空
    frm2->clearPath();
}
